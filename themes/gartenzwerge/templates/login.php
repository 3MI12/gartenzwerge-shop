<div id="loginWrapper" class="content">
    ...
    <div class="titleHr"></div>
        <form id="loginForm" method="post" action="/user/login/">
        	...
        	<label>Passwort</label> <input type="password" name="password" required="required"><br>
    ...
    <div class="titleHr"></div>
       	<form id="regForm" method="post" action="/user/edit/">
            ...
            <label>Vorname</label> <input type="text" name="firstname" required="required"><br>
            <label>Nachname</label> <input type="text" name="lastname" required="required"><br>
            <label>eMail</label> <input type="email" name="email" required="required"><br>
            <label>Passwort</label> <input type="password" name="password" required="required"><br>
