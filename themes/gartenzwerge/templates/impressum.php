<div id="impressumWrapper" class="content">
	<div class="title">
    Impressum
  </div>
  ...
  <p style="clear:both;">
<span style="color:#D8A758;">Achtung: Dieser Onlineshop ist nur zur Demonstration, es besteht kein Anspruch auf Waren oder andere Leistungen. Jegliche Eingabe von Daten ist freiwillig und geschieht nur zum Test der Funktionalität.</span><br />
<br /><br />
Gartenzwerge24.eu<br />
Steve Kuntze <br />
Hechtstraße 40 <br />
01097 Dresden<br />
Telefon: 0351/23419021<br />
eMail: admin@gartenzwerge24.eu<br />
<br />
</p>
	<div class="subtitle">
    	AGB
...
<p style="clear:both;">
1. Zustandekommen des Vertrags <br />
Mit Ihrer Bestellung geben Sie ein verbindliches Angebot an uns ab, einen Vertrag mit Ihnen zu schließen. Mit der Zusendung einer Auftragsbestätigung per E-Mail an Sie oder der Lieferung der bestellten Ware können wir dieses Angebot annehmen. Zunächst erhalten Sie eine Bestätigung des Eingangs Ihrer Bestellung per E-Mail an die von Ihnen angegebene E-Mail-Adresse (Bestellbestätigung). Ein Kaufvertrag kommt jedoch erst mit dem Versand unserer Auftragsbestätigung per E-Mail an Sie oder mit der Lieferung der bestellten Ware zustande.
Bei Eingang einer Bestellung in unserem Internetshop gelten folgende Regelungen: Der Verbraucher gibt ein bindendes Vertragsangebot ab, indem er die in unserem Internetshop vorgesehene Bestellprozedur erfolgreich durchläuft. Die Bestellung erfolgt in folgenden Schritten:<br />
1) Auswahl der gewünschten Ware<br /> 2) Prüfung der Angaben im Warenkorb <br />3) Anmeldung im Internetshop nach Registrierung und Eingabe der Anmelderangaben (E-Mail-Adresse und Passwort). <br />4) Verbindliche Absendung der Bestellung.<br />
<br />

2. Speicherung des Vertragstextes <br />
Den Vertragstext Ihrer Bestellung speichern wir. Ihre vergangenen Bestellungen können Sie in unserem Kunden-Bereich unter Mein Profil --> Meine Bestellungen einsehen. Wir senden Ihnen außerdem eine Bestellbestätigung sowie eine Auftragsbestätigung mit allen Bestelldaten und unseren Allgemeinen Geschäftsbedingungen an die von Ihnen angegebene E-Mail-Adresse.<br />
<br />
...
5. Lieferbedingungen<br />
Sofern nicht beim Angebot anders angegeben, bringen wir die Ware innerhalb von 2 Werktagen nach
Zahlungseingang in den Versand.<br />
<br />

6. Zahlungsbedingungen<br />
Der Verbraucher hat die Möglichkeit der Zahlung per Bankeinzug.<br />
<br />
...
nicht möglich und auch nicht beabsichtigt.<br />
...
beauftragte Kreditinstitut weiter.<br /><br />
...
Ihre Rechte Sollten Sie mit der Speicherung Ihrer personenbezogenen Daten nicht mehr einverstanden oder diese unrichtig geworden sein, werden wir auf eine entsprechende Weisung hin im Rahmen der gesetzlichen Bestimmungen die Löschung, Korrektur oder Sperrung Ihrer Daten veranlassen. Auf Wunsch erhalten Sie unentgeltlich Auskunft über alle personenbezogenen Daten, die wir über Sie gespeichert haben.<br /> Bei Fragen zur Erhebung, Verarbeitung oder Nutzung Ihrer personenbezogenen Daten, für Auskünfte, Berichtigung, Sperrung oder Löschung von Daten wenden Sie sich bitte an:
Gartenzwerge24<br /> Steve Kuntze<br /> Hechtstraße 40<br /><br /> D-01097 Dresden<br /> E-Mail admin@gartenzwerge24.eu<br />
...
9. Anwendbares Recht Es gilt ausschließlich deutsches Recht. Gegenüber einem Verbraucher gilt diese Rechtswahl nur insoweit, als dadurch keine zwingenden gesetzlichen Bestimmungen des Staates, in dem er seinen Wohnsitz oder gewöhnlichen Aufenthalt hat, eingeschränkt werden.
    </p>
